...
urlpatterns = [
      ...
      path('mailings_detail/<int:pk>/', cache_page(60)(MailingDetailView.as_view()), name='mailing_detail'),
      ...
      path('attempt_detail/<int:pk>/', cache_page(60)(AttemptDetailView.as_view()), name='attempt_detail'),
